...
######################################################################################################################
#For hardcoded current time (comment all this out if using current computer time)
...
#######################################################################################################################
#For the current time (Uncomment this if trying to use computer current time)
